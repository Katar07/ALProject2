page 50100 "APIV2 - Sales Invoices"
{
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                // field(signatoryCode1; Rec."Signatory 1 CodeBeHR")
                // {
                ...
                //     // begin
                //     //     RegisterFieldSet(Rec.FieldNo("Signatory 1 CodeBeHR"));
                //     // end;
                // }
                // field(signatoryCode2; Rec."Signatory 2 CodeBeHR")
                // {
                //     Caption = 'Signatory 2 Code';

                //     // trigger OnValidate()
                //     // begin
                //     //     RegisterFieldSet(Rec.FieldNo("Signatory 2 CodeBeHR"));
                //     // end;
                // }
                // field(shipmentDate; Rec."Shipment DateBeHR")
                // {
                //     Caption = 'Shipment Date';

                //     // trigger OnValidate()
                //     // begin
                //     //     RegisterFieldSet(Rec.FieldNo("Shipment DateBeHR"));
                //     // end;
                // }
    ...
    // begin
    //     if SalesHeader.Get(Rec."Document Type"::Invoice, Rec."No.") then begin
    //         Rec."Signatory 1 CodeBeHR" := SalesHeader."Signatory 1 Code-AdDoc";
    //         Rec."Signatory 2 CodeBeHR" := SalesHeader."Signatory 2 Code-AdDoc";
    //         Rec."Shipment DateBeHR" := SalesHeader."Shipment Date";
    //     end;
    // end;
